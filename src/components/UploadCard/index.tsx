    ...
    >
      <Flex vertical align="center" className={style.inner}>
        <div className={style.logoContainer}>
          <img src="/logo.svg" alt="FlexiFunnels Logo" className={style.logo} />
          <Typography.Title level={2} className={style.logoText}>FlexiFunnels - Image Compression</Typography.Title>
        </div>
